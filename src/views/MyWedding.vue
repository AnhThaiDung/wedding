...
import "../assets/js/jquery.dlmenu.js"
        ...
        <div class="preloader">
            <div class="vertical-centered-box">
                <div class="content">
                    ...
                    <img src="src/assets/images/preloader.svg" alt="">
                </div>
            </div>
        </div>
        <!-- end preloader -->
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 col-6 d-lg-none dl-block">
                                <div class="navbar-header">
                                    <a class="navbar-brand" href="index.html"><img src="src/assets/images/logo.svg"
                                            alt=""></a>
                                </div>
                            </div>
                                        ...
                                        <div class="mini-cart-content">
                                            ...
                                            <div class="mini-cart-items">
                                                <div class="mini-cart-item clearfix">
                                                    <div class="mini-cart-item-image">
                                                        <a href="shop.html"><img
                                                                src="src/assets/images/shop/mini-cart/img-1.jpg" alt></a>
                                                    </div>
                                                ...
                                                <div class="mini-cart-item clearfix">
                                                    <div class="mini-cart-item-image">
                                                        <a href="shop.html"><img
                                                                src="src/assets/images/shop/mini-cart/img-2.jpg" alt></a>
                                                    </div>
                                                    <div class="mini-cart-item-des">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="src/assets/images/slider/slide-5.jpg">
                        </div>
                        <!-- end slide-inner -->
                    </div>
                    <!-- end swiper-slide -->
                    ...
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="src/assets/images/slider/slide-6.jpg">
                        </div>
                        <!-- end slide-inner -->
                    </div>
                    <!-- end swiper-slide -->
                    ...
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="src/assets/images/slider/slide-7.jpg">
                        </div>
                        <!-- end slide-inner -->
                    </div>
                    <!-- end swiper-slide -->
                    ...
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="src/assets/images/slider/slide-8.jpg">
                        </div>
                        <!-- end slide-inner -->
                    </div>
                    <!-- end swiper-slide -->
        ...
        <section class="wpo-wedding-date">
            <div class="container">
                <h2 class="wow fadeInUp" data-wow-duration="1000ms">
                    <span class="shape-1"><img src="src/assets/images/slider/shape.png" alt=""></span> Esabella & William
                    <span class="shape-2"><img src="src/assets/images/slider/shape2.png" alt=""> </span>
                </h2>
                    ...
                    <div class="row align-items-center">
                        <div class="col col-md-5 col-12">
                            <div class="couple-item wow fadeInLeftSlow" data-wow-duration="1700ms">
                                <div class="couple-img">
                                    <img src="src/assets/images/couple/img-1.png" alt="">
                                </div>
                                <div class="couple-text">
                                    <h3>Esabella Juliet</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna orci auctor vitae nisl. Erat fringilla pellentesque amet tempus. Commodo mi vitae, sagittis blandit.
                                    </p>
                                    <div class="social">
                                        <ul>
                        ...
                        <div class="col col-md-2 col-12">
                            <div class="middle-couple-shape wow fadeInUp" data-wow-duration="1000ms">
                                <div class="shape">
                                    <img src="src/assets/images/couple/shape.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col col-md-5 col-12">
                            <div class="couple-item wow fadeInRightSlow" data-wow-duration="1700ms">
                                <div class="couple-img">
                                    <img src="src/assets/images/couple/img-2.png" alt="">
                                </div>
                                <div class="couple-text">
                                    <h3>William Jack</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna orci auctor vitae nisl. Erat fringilla pellentesque amet tempus. Commodo mi vitae, sagittis blandit.
        ...
        <section class="wpo-video-section-s2 pb-0 section-padding">
            ...
            <div class="container">
                <div class="video-wrap">
                    <img src="src/assets/images/cta2.jpg" alt="">
                    ...
                    <div class="wpo-story-item">
                        <div class="wpo-story-img-wrap">
                            ...
                            <div class="wpo-img-shape">
                                <img src="src/assets/images/story/shape.png" alt="">
                            </div>
                        </div>
                            ...
                            <div class="portfolio-grids gallery-container clearfix">
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="src/assets/images/portfolio/10.jpg" class="fancybox" data-fancybox-group="gall-1">
                                            <img src="src/assets/images/portfolio/10.jpg" alt class="img img-responsive">
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="src/assets/images/portfolio/5.jpg" class="fancybox" data-fancybox-group="gall-1">
                                            <img src="src/assets/images/portfolio/5.jpg" alt class="img img-responsive">
                                            <div class="hover-content">
                                                <i class="ti-plus"></i>
                                            </div>
                                        </a>
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="src/assets/images/portfolio/6.jpg" class="fancybox" data-fancybox-group="gall-1">
                                            <img src="src/assets/images/portfolio/6.jpg" alt class="img img-responsive">
                                            <div class="hover-content">
                                                <i class="ti-plus"></i>
                                            </div>
                                        </a>
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="src/assets/images/portfolio/7.jpg" class="fancybox" data-fancybox-group="gall-1">
                                            <img src="src/assets/images/portfolio/7.jpg" alt class="img img-responsive">
                                            <div class="hover-content">
                                                <i class="ti-plus"></i>
                                            </div>
                                        </a>
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="src/assets/images/portfolio/8.jpg" class="fancybox" data-fancybox-group="gall-1">
                                            <img src="src/assets/images/portfolio/8.jpg" alt class="img img-responsive">
                                            <div class="hover-content">
                                                <i class="ti-plus"></i>
                                            </div>
                                        </a>
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="src/assets/images/portfolio/9.jpg" class="fancybox" data-fancybox-group="gall-1">
                                            <img src="src/assets/images/portfolio/9.jpg" alt class="img img-responsive">
                                            <div class="hover-content">
                                                <i class="ti-plus"></i>
                                            </div>
                                        </a>
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="src/assets/images/portfolio/11.jpg" class="fancybox" data-fancybox-group="gall-1">
                                            <img src="src/assets/images/portfolio/11.jpg" alt class="img img-responsive">
                                            <div class="hover-content">
                                                <i class="ti-plus"></i>
                                            </div>
                                        </a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col col-xl-8 col-lg-6 col-md-12 col-12">
                        <div class="contact-img wow fadeInRightSlow" data-wow-duration="1700ms">
                            <img src="src/assets/images/contact/img-4.jpg" alt="">

                            <div class="rsvp-info">
                                <div class="info-left">
                                    <h2>We Are Getting Married!</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc, egestas luctus hendrerit maecenas.</p>
                                </div>
                ...
                <div class="row">
                    <div class="col col-xs-12">
                        <div class="partner-grids partners-slider owl-carousel">
                            <div class="grid">
                                <img src="src/assets/images/partners/1.png" alt>
                            </div>
                            <div class="grid">
                                <img src="src/assets/images/partners/2.png" alt>
                            </div>
                            <div class="grid">
                                <img src="src/assets/images/partners/3.png" alt>
                            </div>
                            <div class="grid">
                                <img src="src/assets/images/partners/4.png" alt>
                            </div>
                            <div class="grid">
                                <img src="src/assets/images/partners/5.png" alt>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wpo-event-wrap">
                    <div class="row">
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-event-item">
                                <div class="wpo-event-img">
                                    <img src="src/assets/images/event/2.jpg" alt="">
                                    <div class="title">
                                        <h2>The Ceremony</h2>
                                    </div>
                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-event-item">
                                <div class="wpo-event-img">
                                    <img src="src/assets/images/event/3.jpg" alt="">
                                    <div class="title">
                                        <h2>The Party</h2>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="wpo-blog-grids gallery-container clearfix">
                                    <div class="grid">
                                        <div class="wpo-blog-item">
                                            <div class="wpo-blog-img">
                                                <img src="src/assets/images/blog/img-1.jpg" alt="">
                                            </div>
                                    ...
                                    <div class="grid">
                                        <div class="wpo-blog-item">
                                            <div class="wpo-blog-img">
                                                <img src="src/assets/images/blog/img-2.jpg" alt="">
                                            </div>
                                            <div class="wpo-blog-content">
                                    ...
                                    <div class="grid">
                                        <div class="wpo-blog-item">
                                            <div class="wpo-blog-img">
                                                <img src="src/assets/images/blog/img-3.jpg" alt="">
                                            </div>
                                            <div class="wpo-blog-content">
                                    ...
                                    <div class="grid">
                                        <div class="wpo-blog-item">
                                            <div class="wpo-blog-img">
                                                <img src="src/assets/images/blog/img-4.jpg" alt="">
                                            </div>
                                            <div class="wpo-blog-content">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="footer-image">
                            <a class="logo" href="index.html"><img src="src/assets/images/logo.svg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-12">
